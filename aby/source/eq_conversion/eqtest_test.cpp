...
int main(int argc, char** argv) {
	...
	// call routine. set size with cmd-parameter -n <size>
	test_eqtest_circuit(role, (char*) address.c_str(), port, seclvl, 1, bitlen, nthreads, mt_alg, S_ARITH, nvals);
