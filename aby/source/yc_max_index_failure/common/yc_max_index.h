...
#ifndef __MAX_INDEX_H_
#define __MAX_INDEX_H_
...
/**
 ...
 \param 	n			First matrix is n x m
 \param 	m			Second matrix is m x t
 \param 	t			Second matrix is m x t
 \brief		This function is used for running a testing environment for solving the Matrix Product.
 */
...
/**
 \param		V			shares of n values
 \param 	n			length of V
 \param		yc	 		Arithmetic Circuit object.
 \brief		This function finds the index of the largest element in the vector V
 */
